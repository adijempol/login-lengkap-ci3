...
class User extends CI_Controller
{
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($upload_image) {
                ...
                if ($this->upload->do_upload('image')) {
                    ...
                    //untuk menghapus file gambar jika sudah upload gambar baru
                    //tanpa menghilangkan gambar default
    ...
    public function changePassword()
    {
        ...
        $this->form_validation->set_rules('new_password1', 'New_Password', 'required|trim|min_length[4]|matches[new_password2]');
        $this->form_validation->set_rules('new_password2', 'New_Password', 'required|trim|min_length[4]|matches[new_password1]');
