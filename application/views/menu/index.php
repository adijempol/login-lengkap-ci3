                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="<?= base_url('menu/ubah/'); ?><?= $m['id']; ?>" class="badge badge-warning tampilModalUbah" data-toggle="modal" data-target="#newMenuModal" data-id="<?= $m['id']; ?>">Edit</a>
                                <a href="<?= base_url('menu/deleteMenu/'); ?><?= $m['id']; ?>" class="badge badge-danger tombol-del">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
